function calculateStats() {
	...
	const baseeHP = document.getElementById('baseeHP').innerText;
	const baseATK = document.getElementById('baseATK').innerText;
	const basecrATK = document.getElementById('basecrATK').innerText;
	const baseDEF = document.getElementById('baseDEF').innerText;
	const baseDmgB = document.getElementById('baseDmgB').innerText;
	...
	const gemHP = Math.round( parseInt(calcHP1) + parseInt(calcHP2) + parseInt(calcHP3) + parseInt(calcHP4));
	...
	const gemDEF = Math.round(parseInt(calcDEF1) + parseInt(calcDEF2) + parseInt(calcDEF3) + parseInt(calcDEF4));
	...
	const gemREC = Math.round(parseInt(calcREC1) + parseInt(calcREC2) + parseInt(calcREC3) + parseInt(calcREC4));
	...
	const gemCD = Math.round(calcCD1 + calcCD2 + calcCD3 + calcCD4);
	...
	const gemCR = Math.round(calcCR1 + calcCR2 + calcCR3 + calcCR4);
	...
	document.getElementById('gemeHP').innerText = '+ ' + ((Math.round(FinalHP / (1 - (FinalDEF / (FinalDEF + 1200)))))-baseeHP );
	document.getElementById('buildeHP').innerText = Math.round(FinalHP / (1 - (FinalDEF / (FinalDEF + 1200))));
	...
	document.getElementById('buildREC').innerText = FinalREC;
	document.getElementById('gemREC').innerText = '+ ' + gemREC;

	document.getElementById('buildHeal').innerText = Math.round(FinalREC * 4.5);
	document.getElementById('gemHeal').innerText = '+ ' + (gemREC * 4.5);

	document.getElementById('buildCD').innerText = FinalCD + ' %';
	document.getElementById('gemCD').innerText = '+ ' + gemCD + ' %';

	document.getElementById('buildCR').innerText = FinalCR + ' %';
	document.getElementById('gemCR').innerText = '+ ' + gemCR + ' %';
