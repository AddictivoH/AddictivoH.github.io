function calculateStats() {
	...
	let baseHP = document.getElementById("baseHP").innerText;
	let baseATK = document.getElementById("baseATK").innerText;
	let baseDEF = document.getElementById("baseDEF").innerText;
	let baseREC = document.getElementById("baseREC").innerText;
	let baseCD = document.getElementById("baseCD").innerText;
	let baseCR = document.getElementById("baseCR").innerText;
	let gem1 = document.getElementById("gem1").value;
	let gem2 = document.getElementById("gem2").value;
	let gem3 = document.getElementById("gem3").value;
	let gemSet = document.getElementById("gemSet").value;
	let AggrCS = document.getElementById("AggrCS").value;
	...
	let FinalHP = Math.round(parseInt(baseHP) + parseInt(calcHP1) + parseInt(calcHP2) + parseInt(calcHP3) + parseInt(calcHP4));
	...
	let FinalDEF = Math.round(parseInt(baseDEF) + parseInt(calcDEF1) + parseInt(calcDEF2) + parseInt(calcDEF3) + parseInt(calcDEF4));
	...
	let FinalREC = Math.round(parseInt(baseREC) + parseInt(calcREC1) + parseInt(calcREC2) + parseInt(calcREC3) + parseInt(calcREC4));
	...
	let FinalCD = Math.round(parseInt(baseCD) + calcCD1 + calcCD2 + calcCD3 + calcCD4);
	...
	let FinalCR = Math.round(parseInt(baseCR) + calcCR1 + calcCR2 + calcCR3 + calcCR4);
